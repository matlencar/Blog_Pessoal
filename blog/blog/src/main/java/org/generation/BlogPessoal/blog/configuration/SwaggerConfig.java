package org.generation.BlogPessoal.blog.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket (DocumentationType.SWAGGER_2)
				...
				.basePackage("org.generation.BlogPessoal.blog.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				...
				.licenseUrl("https://github.com/matlencar")
				.contact(contact())
				.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Matheus Alencar Silva", "https://github.com/matlencar", "malencar292@gmail.com");
	}
